"""Agent avec mémoire à long terme : les souvenirs pertinents rejoignent le contexte."""
...
if len(sys.argv) < 2:
    print('Usage : uv run python exemples-code/09-memoire-vectorielle.py "votre question"')
    sys.exit(1)
